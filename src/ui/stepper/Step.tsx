        ...
        <button
            className={clsx("h-[50px] flex-1 flex items-center group rounded-[10px] focus-ring",
                ...
                onClick && "cursor-pointer hover:bg-black/4 active:bg-black/6 " +
                    "dark:hover:bg-white/4 dark:active:bg-white/2")}
            onClick={onClick}
        >
            <div className="flex-1 h-[2px] bg-black/15 dark:bg-white/5 group-first:invisible"/>

            <div className={clsx("mx-[2px] size-[30px] rounded-[10px] overflow-clip text-[14px] font-[450]",
                (selected)
                    ? "bg-teal-70 dark:bg-teal-75 text-white"
                    : "bg-black/10 dark:bg-white/5 text-gray-70 dark:text-gray-45")}>
            ...
            <div className="flex-1 h-[2px] bg-black/15 dark:bg-white/5 group-last:invisible"/>
        </button>
    );
}
